---
description: Turn .memory/ai/context.md → step-by-step implementation plan (uses implementation-planner agent)
...
1. Read `.memory/ai/context.md` — extract goals, constraints, TODOs, open questions
2. Decide MVP slice + later phases + dependencies
3. Write plan to `.memory/ai/implementation-planner-plan.md`
4. Append 3-line summary to `.memory/ai/context.md`
